...
public class MainPage {
    ...
    private By trainingSimulator = By.className("Header_Disclaimer__3VEni");
    ...
    private By faqQuestions = By.xpath(".//div[@class='accordion__item']");
    //Список "Вопросы о важном" вопрос 1
    private By faqQuestionOne = By.xpath(".//div[@class='accordion__item'][1]//div[@class='accordion__button']");
    //Список "Вопросы о важном" вопрос 2
    private By faqQuestionTwo = By.xpath(".//div[@class='accordion__item'][2]//div[@class='accordion__button']");
    //Список "Вопросы о важном" вопрос 3
    private By faqQuestionThree = By.xpath(".//div[@class='accordion__item'][3]//div[@class='accordion__button']");
    //Список "Вопросы о важном" вопрос 4
    private By faqQuestionFour = By.xpath(".//div[@class='accordion__item'][4]//div[@class='accordion__button']");
    //Список "Вопросы о важном" вопрос 5
    private By faqQuestionFive = By.xpath(".//div[@class='accordion__item'][5]//div[@class='accordion__button']");
    //Список "Вопросы о важном" вопрос 6
    private By faqQuestionSix = By.xpath(".//div[@class='accordion__item'][6]//div[@class='accordion__button']");
    //Список "Вопросы о важном" вопрос 7
    private By faqQuestionSeven = By.xpath(".//div[@class='accordion__item'][7]//div[@class='accordion__button']");
    //Список "Вопросы о важном" вопрос 8
    private By faqQuestionEight = By.xpath(".//div[@class='accordion__item'][8]//div[@class='accordion__button']");
    //Список "Вопросы о важном" текст вопросов
    private By faqQuestionsText = By.xpath(".//div[@class='accordion']");
    //Список "Вопросы о важном" видимые ответы
    private By faqAnswerVisible = By.xpath(".//p/parent::div[not(@hidden)]");
